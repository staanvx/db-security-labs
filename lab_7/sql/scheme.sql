...
CREATE ROLE alice LOGIN; -- начальник отдела 1
CREATE ROLE bob LOGIN; -- начальник отдела 2
CREATE ROLE cristian LOGIN; -- сотрудник отделов 1 и 2
CREATE ROLE denis LOGIN; -- сотрудник отделов 1
